...
polish_resume_interface = gr.Interface(
    fn=polish_resume,
    inputs=[
        gr.Textbox(label="Position Name", placeholder="Enter the position you are applying for..."),
        gr.Textbox(label="Resume Content", placeholder="Paste your resume content here..."),
        gr.Textbox(label="Polish Prompt", placeholder="Optional: Provide specific instructions for polishing")
    ],
    outputs=gr.Textbox(label="Polished Resume", placeholder="Your polished resume will appear here..."),
    title="Resume Polisher",
    description="Upload your resume and specify the position you are applying for. The model will polish your resume to better fit the job description."
)
